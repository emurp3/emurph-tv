...
if old_css not in s:
    raise SystemExit('Expected logo CSS block not found')
if old_logo not in s:
    raise SystemExit('Expected top logo block not found')
...
print('Approved EMurph TV branding applied')
